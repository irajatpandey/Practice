...
bool checkIsomorphic(BinaryTree<int> *root1, BinaryTree<int> *root2){
    ...
    return checkIsomorphic(root1 -> left, root2 -> left) and 
           checkIsomorphic(root1 -> right, root2 -> right) 
           or
           checkIsomorphic(root1 -> left, root2 -> right) and 
           checkIsomorphic(root1 -> right, root2 -> left);
}
