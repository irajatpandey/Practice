...
bool checkMirrorTree(BinaryTree<int> *root1, BinaryTree<int> *root2){
    ...
    return (root1 -> data == root2 -> data) and checkMirrorTree(root1 -> left, root2 -> right) and checkMirrorTree(root1 -> right, root2 -> left);
}
bool checkSymmetry(BinaryTree<int> *root){
